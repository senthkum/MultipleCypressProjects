...
{
    static PurchaseComputers(getData)
    {
        ...
        cy.Clickonlink('Computers')
        
        // Select the Subproduct from the table
        // cy.SubCategories(getData.DNA)
        cy.get('div.page-body').find('div.sub-category-item').contains('Desktops').click()
